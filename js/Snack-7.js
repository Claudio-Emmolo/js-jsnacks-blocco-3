/**
 * Crea due tag div con due id diversi. OK
 * Un div avrà il testo colorato di rosso mentre l'altro di verde. OK
 ...
 */
 ...
 for (let i = 0 ; i < array.length ; i++){
    if(array[i] % 2 == 0){
        RedElement.append(addPElement(array[i]));
    } else {
        GreenElement.append(addPElement(array[i]));
    }
 }
